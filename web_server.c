...
static void build_page(char *out, size_t out_len) {
    snprintf(out, out_len,
        ...
        "<label><input type='checkbox' id='act_inject' style='width:22px;height:22px;vertical-align:middle;'/> Inject energy</label><br/>"
        "<label><input type='checkbox' id='act_absorb' style='width:22px;height:22px;vertical-align:middle;'/> Absorb energy</label>"
        "</div></foreignObject>"
